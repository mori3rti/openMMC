...
Delay a task for a given number of ticks. The actual time that the task remains blocked depends on the tick rate. The constant port\-T\-I\-C\-K\-\_\-\-P\-E\-R\-I\-O\-D\-\_\-\-M\-S can be used to calculate real time from the tick rate -\/ with the resolution of one tick period.
...
void v\-Task\-Function( void $\ast$ pv\-Parameters ) \{ Block for 500ms. const Tick\-Type\-\_\-t x\-Delay = 500 / port\-T\-I\-C\-K\-\_\-\-P\-E\-R\-I\-O\-D\-\_\-\-M\-S; \begin{DoxyVerb}for( ;; )
{
\end{DoxyVerb}
